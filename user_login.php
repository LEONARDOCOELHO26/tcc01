...
if (isset($_POST["login"])) {
    ...
    $stmt = $conn->prepare("SELECT id, senha FROM usuarios WHERE usuario = ? OR cpf = ?");
...
<body>
    <form method="post" action="">
        <div class="loginbox">
            ...
            <label for="usuario" class="loginlabel">Usuário ou CPF</label>
            <input name="usuario" id="usuario" type="text" class="logininput" placeholder="Digite seu usuário ou CPF" required>
